...
public class MarioESNNController2 extends BasicMarioAIAgent implements Agent {
	...
	public MarioESNNController2(String startingWeightsFile) {
	    super("ESNNController");
	    r = new Random(System.currentTimeMillis());
	    sigma = r.nextDouble() * 2;
	...
	public MarioESNNController2(MarioESNNController2 other) {
	    super("ESNNController");
	    r = new Random(System.currentTimeMillis());
	    sigma = other.sigma;
