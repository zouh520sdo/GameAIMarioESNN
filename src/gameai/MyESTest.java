...
public class MyESTest 
{
    ...
    {
        ESnew es = new ESnew(populationSize, "best_huang_1_level0_input8_8_NN12_12_randomcrossoverwithnew_mutaterandom0_1.txt");
        es.outputFile= "best_huang_1_level0.txt";
